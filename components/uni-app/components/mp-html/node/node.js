...
const node = () => Promise.resolve().then(() => RzovVGlueVRhbGUvVGlueVRhbGUtMS4wLjAg5q2j5byP54mIL1RpbnlUYWxlLTEuMC4wIOatoW8jEJiC9IYWxvLVRpbnlUYWxlLTEuMC4wL3NyYy9jb21wb25lbnRzL3VuaS1hcHAvY29tcG9uZW50cy9tcC1odG1sL25vZGUvbm9kZS52dWU);
const _sfc_main = {
  name: "node",
  options: {
    virtualHost: true
...
if (!Array) {
  ...
  (_component_node + _component_my_audio + _component_txv_video)();
}
  ...
  return {
    a: common_vendor.f($props.childs, (n, i, i0) => {
      return common_vendor.e({
        ...
        ac: common_vendor.f(n.children, (tbody, x, i1) => {
          return common_vendor.e({
        ...
        ad: n.attrs.id,
        ae: common_vendor.n("_" + n.name + " " + n.attrs.class),
        af: common_vendor.s(n.attrs.style)
      }) : n.name == "audio" ? {
        ah: common_vendor.n(n.attrs.class),
        ai: common_vendor.s(n.attrs.style),
        aj: i,
        ak: common_vendor.o($options.play, i),
        al: common_vendor.o($options.mediaError, i),
        am: "e503d58c-5-" + i0,
        an: common_vendor.p({
          aid: n.attrs.id,
        ...
        ap: [n],
        aq: n.attrs["data-content"],
        ar: n.attrs["data-lang"],
        as: common_vendor.o((...args) => $options.copyCode && $options.copyCode(...args), i)
      } : n.name == "txv-video" ? {
        av: n.attrs.vid,
        aw: common_vendor.n(n.attrs.class),
        ax: common_vendor.s(n.attrs.style),
        ay: i,
        az: common_vendor.o($options.play, i),
        aA: common_vendor.o($options.mediaError, i),
        aB: "e503d58c-6-" + i0,
        aC: common_vendor.p({
          vid: n.attrs.vid,
        ...
        C: n.name === "a",
        K: n.name === "video",
        Y: n.name === "table" && n.c || n.name === "li",
        ag: n.name == "audio",
        ao: n.attrs && n.attrs["data-content"],
        at: n.name == "txv-video",
        aD: !n.c,
        aJ: n.c === 2,
        aR: i
...
if (typeof block0 === "function")
  block0(_sfc_main);
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "G:/TinyTale/TinyTale-1.0.0 正式版/TinyTale-1.0.0 正式版/Halo-TinyTale-1.0.0/src/components/uni-app/components/mp-html/node/node.vue"]]);
wx.createComponent(Component);
const RzovVGlueVRhbGUvVGlueVRhbGUtMS4wLjAg5q2j5byP54mIL1RpbnlUYWxlLTEuMC4wIOatoW8jEJiC9IYWxvLVRpbnlUYWxlLTEuMC4wL3NyYy9jb21wb25lbnRzL3VuaS1hcHAvY29tcG9uZW50cy9tcC1odG1sL25vZGUvbm9kZS52dWU = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null
